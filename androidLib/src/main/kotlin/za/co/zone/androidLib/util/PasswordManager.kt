...
class PasswordManager {
	...
	private val maxPasswordLength = MAX_PASSWORD_LENGTH //Max password length that my app creates
	private val maxPasswordFactor = MAX_PASSWORD_FACTOR //Max password factor based on chars inside password
	...
	companion object {
		...
		const val MAX_PASSWORD_LENGTH = 20F
		const val MAX_PASSWORD_FACTOR = 6F
	}
